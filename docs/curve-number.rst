...
- :math:`RO_{tot,t}`: total present run-off at timestep t (:math:`m^3`)
- :math:`RO_{r,t-1}`: run-off still present since previous timestep t-1 (:math:`m^3`)
- :math:`RO_{P,t}`: run-off generated by rainfall during timestep t (:math:`m^3`)
- :math:`RO_{in,t-1}`: upstream run-off generated at timestep t-1 (:math:`m^3`)
...
- :math:`RO_{out,t}`: run-off leaving the grid cell towards the neighbouring
